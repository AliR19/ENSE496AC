...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        distribution = [i[0] for i in items]
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for i in self.allPositions:
            all_positions=self.getObservationProb(observation,pacman_position,i,jail_position)
            distance[i]=all_positions*self.beliefs[i]
        distance.normalize()
        self.beliefs.normalize()
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            temp=self.beliefs[oldPos]
            for newPos in newPosDist.keys():
                distance[newPos]=distance[newPos] +temp*newPosDist[newPos]
